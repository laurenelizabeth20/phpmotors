...
function buildVehiclesDisplay($vehicles){
    ...
    foreach ($vehicles as $vehicle) {
     ...
     "' title='View $vehicle[invMake] $vehicle[invModel]'><img src='$vehicle[imgPath]' alt='Image of $vehicle[invMake] $vehicle[invModel] on phpmotors.com'></a>";
     $dv .= '<hr>';
     $dv .= "<a href='/phpmotors/vehicles/?action=vehicleInfo&invId="
     .urlencode($vehicle['invId']).
...
function buildAdditionalImages($additionalImages, $vehicleInfo){
    $dv = '<br><h2>Additional Images</h2><br>';
    $dv .= '<ul id="additionalImages">';
    if (is_array($additionalImages) || is_object($additionalImages)){
        foreach ($additionalImages as $image) {
            $dv .= '<li>';
            $dv .= "<img src='$image' alt='Image of $vehicleInfo[invMake] $vehicleInfo[invModel] on phpmotors.com'>";
            $dv .= '</li>';
        }
    }
    $dv .= '</ul>';
